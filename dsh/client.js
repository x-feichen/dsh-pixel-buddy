...
"use strict";var rt=Object.defineProperty;var ue=Object.getOwnPropertyDescriptor;var ge=Object.getOwnPropertyNames;var pe=Object.prototype.hasOwnProperty;var kt=e=>{throw TypeError(e)};var fe=(e,i)=>{for(var t in i)rt(e,t,{get:i[t],enumerable:!0})},ye=(e,i,t,n)=>{if(i&&typeof i=="object"||typeof i=="function")for(let s of ge(i))!pe.call(e,s)&&s!==t&&rt(e,s,{get:()=>i[s],enumerable:!(n=ue(i,s))||n.enumerable});return e};var me=e=>ye(rt({},"__esModule",{value:!0}),e);var nt=(e,i,t)=>i.has(e)||kt("Cannot "+t);var r=(e,i,t)=>(nt(e,i,"read from private field"),t?t.call(e):i.get(e)),l=(e,i,t)=>i.has(e)?kt("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(e):i.set(e,t),d=(e,i,t,n)=>(nt(e,i,"write to private field"),n?n.call(e,t):i.set(e,t),t),h=(e,i,t)=>(nt(e,i,"access private method"),t);var Ie={};fe(Ie,{apply:()=>_e,inject:()=>Re});module.exports=me(Ie);var a=require("react"),Et=require("@deepseek-ai/dsh-client-ui-primitives");var At=[32,40,48],Q=48,Y=16,st=8,Ft=3;function ot(e,i=window.innerHeight,t=48){let n=Math.max(st,i-t-st);return Math.min(n,Math.max(st,Math.round(e)))}var xe={running:'<rect x="9" y="9" width="6" height="6"/>',"input-required":'<text x="12" y="17.5" text-anchor="middle" font-size="15" font-weight="700">?</text>',error:'<text x="12" y="17.5" text-anchor="middle" font-size="15" font-weight="700">!</text>',success:'<path d="M7 12.5 L10.5 16 L17 8.5" stroke-width="2.5" fill="none"/>'},ht={idle:"\u4F1A\u8BDD\u7A7A\u95F2",running:"\u4F1A\u8BDD\u8FD0\u884C\u4E2D","input-required":"\u4F1A\u8BDD\u9700\u8981\u4EBA\u5DE5\u4ECB\u5165",error:"\u4F1A\u8BDD\u51FA\u73B0\u5F02\u5E38",success:"\u4EFB\u52A1\u6210\u529F\u5B8C\u6210"};function Dt(e){return`<svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  </svg>`},blinkOverlay(){return'<rect x="4" y="4" width="1" height="1" fill="#E8873A"/><rect x="8" y="4" width="1" height="1" fill="#E8873A"/><rect x="4" y="4" width="1" height="1" fill="#C96F1F"/><rect x="8" y="4" width="1" height="1" fill="#C96F1F"/>'}};var _t={id:"penguin",label:"\u4F01\u9E45",svg(){return`<svg viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
    <!-- \u5934\u90E8\uFF08\u6DF1\u84DD\u7070\uFF09 -->
    <g fill="#39465A">
  ...
  </svg>`},blinkOverlay(){return'<rect x="4" y="4" width="1" height="2" fill="#39465A"/><rect x="8" y="4" width="1" height="2" fill="#39465A"/><rect x="4" y="5" width="1" height="1" fill="#F5F7FA"/><rect x="8" y="5" width="1" height="1" fill="#F5F7FA"/>'}};var Ot={id:"panda",label:"\u718A\u732B",svg(){return`<svg viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
    <!-- \u5706\u8033\uFF08\u9ED1\uFF09 -->
  ...
  </svg>`},blinkOverlay(){return'<rect x="2" y="1" width="3" height="3" fill="#6FBF4A"/><rect x="7" y="1" width="3" height="3" fill="#6FBF4A"/><rect x="3" y="2" width="1" height="1" fill="#4C8F33"/><rect x="8" y="2" width="1" height="1" fill="#4C8F33"/>'}};var dt={duck:Ct,cat:Mt,dog:Pt,rabbit:Lt,fox:Rt,penguin:_t,panda:Ot,frog:Ht},be="duck",si=Object.values(dt);function lt(e){return(e!=null?dt[e]:void 0)??dt[be]}var we=214748e4,Se=150,Be=`
  :host {
    position: fixed;
    right: ${Y}px;
    left: auto;
